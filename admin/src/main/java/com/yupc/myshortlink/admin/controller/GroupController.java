...
public class GroupController {
     ...
     * 新建短链接分组
     */
    @PostMapping("/api/myshortlink/admin/v1/group")
     ...
     * 获取短链接分组列表
     */
    @GetMapping("/api/myshortlink/admin/v1/group")
     ...
     * 更新短链接分组
     */
    @PutMapping("/api/myshortlink/admin/v1/group")
     ...
     * 删除短链接分组
     */
    @DeleteMapping("/api/myshortlink/admin/v1/group")
    ...
    @PostMapping("/api/myshortlink/admin/v1/group/sort")
